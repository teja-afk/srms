...
<head>
    <title>PHCET - Check Your Results Here</title>

    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="X-UA-Compatible" content="IE=7" />
    <link rel="shortcut icon" href="../assets/images/mes-favicon.png" type="image/x-icon" />
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="../index.html">
            <img class="logo-one" src="../asset/logo and favicon/University-Logo.png" alt="Navbar logo" />
        </a>
